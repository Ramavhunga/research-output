...
public class SampleDataLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
       ...
       try {
           ...
           Author author = new Author("Alice Tharage", "0000-0001-2345-6789", "University of Venda");
           Outlet outlet1 = new Outlet("Journal of Science", "1234-5678", "978-3-16-148410-0", "12", "3", "45-67", "2024-06-01");
           researchOutputRepo.save(new ResearchOutput("AI in Public Sector", "This paper explores AI adoption in government services.", 2024, "10.1234/ai.ps.2024", OutputStatus.APPROVED, "Journal Article", outlet1, List.of(author1,author)));


           author = new Author("Bob Johnson", "0000-0002-3456-7890", "Institute of Research");
           author1 = new Author("Bob Johnson", "0000-0002-3456-7890", "Institute of Research");
           Outlet outlet2 = new Outlet("Tech Review", "8765-4321", "978-1-23-456789-7", "5", "1", "10-20", "2023-12-15");
           researchOutputRepo.save(new ResearchOutput("Quantum Computing Advances", "This paper discusses breakthroughs in quantum computing.", 2023, "10.5678/qc.adv.2023", OutputStatus.APPROVED, "Conference Paper", outlet2, List.of(author1,author)));
